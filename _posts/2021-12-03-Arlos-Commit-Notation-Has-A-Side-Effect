...
After the course completed, I decided to apply the new tools I'd learned to my regular practise sessions. After a few katas working in this way, I started to notice a side effect of Arlo's Commit Notation that didn't really match it's original intent at all. When I use it, disciplined, high-order TDD becomes easier. Without it, I'm back to the same old refactor-and-add-feature slog.
...
At first this was difficult, and it took a long time to achieve, but as I continued writing code using this notation, I began to notice my code becoming easier to change. Because I was always changing my code in order to add features more easily, I was constantly optimizing for changeability in the right places, and it was more likely that new features would be easier to add. I had to think about design less and less. This was allowing me to TDD more quickly, and better than when I'd tried TDD before.
